...
export const thunderstorm = {
    name: "thunderstorm",
    colors: {
        background: `url(${thunderstormImage})`, color: `${colorPallete.thunder}`,
    }
}
export const drizzle = {
    name: "drizzle",
    colors: {
        background: `url(${drizzleImage})`, color: `${colorPallete.drizzle}`,
    }
}
export const snow = {
    name: "snow",
    colors: {
        background: `url(${snowImage})`, color: `${colorPallete.snow}`,
    }
}
export const mist = {
    name: "mist",
    colors: {
        background: `url(${mistImage})`, color: `${colorPallete.mist}`,
    }
}
...
export const smoke = {
    name: "smoke",
    colors: {
        background: `url(${smokeImage})`, color: `${colorPallete.smoke}`,
    }
}
export const fog = {
    name: "fog",
    colors: {
        background: `url(${fogImage})`, color: `${colorPallete.fog}`,
    }
}
...
export const haze = {
    name: "haze",
    colors: {
        background: `url(${hazeImage})`, color: `${colorPallete.haze}`,
    }
}